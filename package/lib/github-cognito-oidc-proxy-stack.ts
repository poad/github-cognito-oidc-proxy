...
export class GithubCognitoOidcProxyStack extends cdk.Stack {
  constructor(
    scope: Construct,
    id: string,
    props: GithubCognitoOidcProxyStackProps,
  ) {
    ...
    const configLogs = new LogGroup(
      this,
      'GithubCognitoOidcProxyConfigFunctionLogGroup',
      {
    ...
    const config = new NodejsFunction(
      this,
      'GithubCognitoOidcProxyConfigFunction',
      {
        ...
        role: new Role(
          this,
          'GithubCognitoOidcProxyConfigFunctionExecutionRole',
          {
    ...
    const jwksLogs = new LogGroup(
      this,
      'GithubCognitoOidcProxyJwksFunctionLogGroup',
      {
    ...
    const jwks = new NodejsFunction(
      ...
      'GithubCognitoOidcProxyJwksFunction',
      {
        ...
        role: new Role(
          this,
          'GithubCognitoOidcProxyJwksFunctionExecutionRole',
          {
            assumedBy: new ServicePrincipal('lambda.amazonaws.com'),
            inlinePolicies: {
              'logs-policy': new PolicyDocument({
    ...
    const userInfoLogs = new LogGroup(
      this,
      'GithubCognitoOidcProxyUserInfoFunctionLogGroup',
      {
    ...
    const userInfo = new NodejsFunction(
      this,
      'GithubCognitoOidcProxyUserInfoFunction',
      {
        ...
        role: new Role(
          this,
          'GithubCognitoOidcProxyUserInfoFunctionExecutionRole',
          {
            assumedBy: new ServicePrincipal('lambda.amazonaws.com'),
            inlinePolicies: {
              'logs-policy': new PolicyDocument({
    ...
    const authorizeLogs = new LogGroup(
      this,
      'GithubCognitoOidcProxyAuthorizeFunctionLogGroup',
      {
    ...
    const authorize = new NodejsFunction(
      this,
      'GithubCognitoOidcProxyAuthorizeFunction',
      {
        ...
        role: new Role(
          this,
          'GithubCognitoOidcProxyAuthorizeFunctionExecutionRole',
          {
            assumedBy: new ServicePrincipal('lambda.amazonaws.com'),
            inlinePolicies: {
              'logs-policy': new PolicyDocument({
    ...
    const tokenLogs = new LogGroup(
      this,
      'GithubCognitoOidcProxyTokenFunctionLogGroup',
      {
    ...
    const token = new NodejsFunction(
      this,
      'GithubCognitoOidcProxyTokenFunction',
      {
        ...
        role: new Role(
          this,
          'GithubCognitoOidcProxyTokenFunctionExecutionRole',
          {
            assumedBy: new ServicePrincipal('lambda.amazonaws.com'),
            inlinePolicies: {
              'logs-policy': new PolicyDocument({
    ...
    wellKnown
      ...
      .addMethod('GET', new LambdaIntegration(jwks));
    wellKnown
      .addResource('openid-configuration')
      .addMethod('GET', new LambdaIntegration(config));
    ...
    api.root
      ...
      .addMethod('GET', new LambdaIntegration(authorize));
